...
const AboutProject = () => {
  return (
    <motion.div
      id="about"
      className="bg-gray-100 p-4 mt-4 flex flex-col items-center md:flex-row md:items-start rounded-lg shadow-lg"
    ...
    >
      <div className="flex flex-col justify-center md:mr-8">
        ...
        <h2 className="text-3xl font-bold mb-4 text-center md:text-left text-blue-700">About the Project</h2>
